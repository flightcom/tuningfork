...
class Register extends MY_Controller {
	...
	{
        $content = $this->load->view('public/layout/register/signin', NULL, TRUE);
        $this->load->view('public/layout/master', array('title' => 'Connexion', 'content' => $content));
    ...
    public function signup()
    {
        if ($this->input->post())
        {
            ...
            error_log(print_r($membre->toArray(), true));
            ...
            $content = $this->load->view('public/layout/register/signup', NULL, TRUE);
            $this->load->view('public/layout/master', array('title' => 'Création de compte', 'content' => $content));
        }
    }
