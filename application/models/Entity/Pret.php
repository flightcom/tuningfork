...
class Pret extends BaseEntity
{
     ...
     */
    protected $cautionVersee;

    /**
     * @Column(type="boolean", options={"default" : false})
     */
    protected $cautionRendue;
    ...
    /**
     * @ManyToOne(targetEntity="Entity\PretStatus")
     */
    protected $status;
     ...
     * @PreUpdate
     */
    // public function __pret_doPreUpdate ()
    // {
    //     // Status
    //     $this->status = PretStatus::calculateStatus($this->dateDebutPrevue, $this->dateDebut, $this->dateFinPrevue, $this->dateFin);
    // }
