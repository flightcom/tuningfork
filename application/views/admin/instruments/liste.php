<table ng-table="tiParams" show-filter="true" class="table table-hover col-xs-12 nopadding">
    ...
    <tbody>
		...
		<tr ng-repeat="instrument in filteredInstruments" ng-click="go('/admin/instruments/' + instrument.instru_id)" style="cursor:pointer;" class="border-state-{{instrument.instru_etat}}" ng-class="instrument.instru_dispo =='1' ? 'border-left-ok' : 'border-left-ko'">
