    ...
    <form method="post" action="/membres/create" name='newaccount' class='form-horizontal' autocomplete='off' novalidate ng-controller='AddMembreCtrl'>
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="col-xs-12 col-md-10 has-feedback" ng-class="{'has-success' : newaccount.genre.$valid, 'has-error': newaccount.genre.$invalid && newaccount.genre.$dirty}">
                <?php foreach ( Membre_model::get_genders() as $i => $g) { ?>
                <div>
        ...
        <div class="form-group row">
            <div class="col-xs-12 col-lg-6 has-feedback" ng-class="{'has-success' : newaccount.nom.$valid, 'has-error': newaccount.nom.$invalid && newaccount.nom.$dirty}">
            ...
            <div class="col-xs-12 col-lg-6 has-feedback" ng-class="{'has-success' : newaccount.prenom.$valid, 'has-error': newaccount.prenom.$invalid && newaccount.prenom.$dirty}">
        ...
        <div class="form-group row">
            ...
            <div class="col-xs-2">
                <input type="text" class="form-control" name="cp" size="5" autocomplete="off" placeholder="CP" pattern="^\d{5}$" ng-model="membre.ville_code_postal" ng-init="membre.ville_code_postal='<?php echo set_value('cp'); ?>'">
            </div>
