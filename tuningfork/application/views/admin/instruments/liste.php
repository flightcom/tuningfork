...
<button ng-click="tableParams.sorting({})" class="btn btn-default pull-right" style="margin-right:10px;">RàZ tri</button>
...
<table ng-show="showTable" ng-table="tableInstruments" show-filter="true" class="table table-hover col-xs-12" ng-controller="AdminListInstruCtrl">
