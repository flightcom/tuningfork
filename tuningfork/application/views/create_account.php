...
<?php echo form_open('account/create', array('id' =>'create-account', 'class' => 'form-horizontal')); ?>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-1">
            <input type="text" class="form-control" id="adr-num" name="adr-num" placeholder="N°" />
        </div>
        <div class="col-xs-2">
        ...
        <div class="col-xs-2">
            <input type="text" class="form-control" id="adr-voie" name="adr-voie" placeholder="Voie" />
        </div>
        <div class="col-xs-1">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-9">
			...
			<button type="submit" class="col-xs-10 btn btn-success pull-middle">Valider</button>
